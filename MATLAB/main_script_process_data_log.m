...
for i=1:n_rows
    ...
    dir_sensor= data(i,theta_bot_col)+data(i,theta_sensor_col);
    ...
    is_measurement_low_enough_that_its_not_a_wall_via_heuristic_col=is_measurement_low_enough_that_we_are_sure_its_not_a_wall_FUNCT(  x_robot, y_robot , dir_sensor,        sensor_range,        board, grid_len_INCHES ) ;
end
