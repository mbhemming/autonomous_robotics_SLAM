function [ intersect_left, intersect_right, intersect_bottom, intersect_top ] = which_wall_will_the_robots_direction_collide_with(x_bot,y_bot,    dir_x_component, dir_y_component,   x_board_top_corner,y_board_top_corner  )
...
%   Detailed explanation goes here
    ...
    [ x_min_search,y_min_search,   x_max_search,y_max_search ] = get_dimensions_a_trejectory_could_hit_wall2( x_bot,y_bot,    dir_x_component, dir_y_component,   x_board_top_corner,y_board_top_corner )
    ...
    x_intersect= (y_board_top_corner-b_robot_path)/m_robot_path;
    if (0 <= x_intersect) & (x_intersect <= x_board_top_corner)
       intersect_top=1; 
    else
        intersect_top=0;
    end
    ...
    if (0 <= y_intersect) & (y_intersect <= y_board_top_corner)
       intersect_left=1; 
    else
        intersect_right=0;
    end
