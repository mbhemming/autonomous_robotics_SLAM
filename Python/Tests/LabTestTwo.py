...
Points = [ Point( 61.0, 10.0 ), Point (61.0 , 30.0),Point (61.0, 50.0)]
...
#		print("time 1inch: " +str(current_milli_time()-t))	
		t = current_milli_time()
		bot.GatherSensorMeasurements(20,180,15.0,grid2)
		print("time 2 inch: " +str(current_milli_time()-t))	
		t = current_milli_time()
		data=bot.GatherSensorMeasurements(20,180,15.0,grid3)
